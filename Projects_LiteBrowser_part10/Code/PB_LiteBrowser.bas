...
END FUNCTION
'
FUNCTION funBuildTable(lngStart AS LONG) AS LONG
' build a table structure
  ...
  funDisplayTable(a_strTable(), strCaption, lngHeader)
  '
END FUNCTION
'
...
' display the table on the graphics control
  ...
  GRAPHIC GET POS TO g_lngX, g_lngY
  '
  FOR lngRow = 1 TO UBOUND(a_strTable,1)
    '
