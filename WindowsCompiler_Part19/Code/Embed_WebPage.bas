...
%IDC_colTitle = 5000     ' handle of the chart title colour picker
'------------------------------------------------------------------------------
...
#PBFORMS BEGIN DIALOG %IDD_dlgReporter->->
  ...
  CONTROL ADD TEXTBOX, hDlg, %IDC_txtWidth, "0", 20, 60, 45, 13, %WS_CHILD OR _
  ...
  CONTROL ADD LABEL,   hDlg, %IDC_lblColourTester, "Label2", 240, 25, 100, 20
#PBFORMS END DIALOG
  '
  AttachMENU1 hDlg
  AttachACCELERATOR1 hDlg
  '
  funPlaceColourPicker(hDlg,%IDC_txtTitle,%IDC_colTitle)
  '
