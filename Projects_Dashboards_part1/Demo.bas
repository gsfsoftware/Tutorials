...
SUB DoTheChart(BYVAL hParentDlg AS LONG)
    ...
    tRegion.nWidth      = 395
    tRegion.nHeight     = 420
    tRegion.sFooter     = "Created 23rd Oct 2022"
    ...
    nRetVal = RMC_AddGridlessSeriesI(%ID_RMC1,1, aData(0), 4,0,0, tGridlessSeries)
    IF nRetVal < 0 THEN GOTO IsError
    '************** Add Region 2 *****************************
    tRegion.nLeft       = 400
    tRegion.nTop        = 5
    ...
    nRetVal = RMC_AddGridlessSeriesI(%ID_RMC1,2, aData(0), 4,aColor(0),4, tGridlessSeries)
    IF nRetVal < 0 THEN GOTO IsError
    '************** Add Region 3 *****************************
    tRegion.nLeft       = 5
    tRegion.nTop        = 445
