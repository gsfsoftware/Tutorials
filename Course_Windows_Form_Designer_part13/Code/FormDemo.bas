...
#PBFORMS BEGIN DIALOG %IDD_dlgGetTitle->%IDR_MENU1->
  ...
  CONTROL ADD BUTTON,   hDlg, %IDC_SUBMIT, "Submit", 225, 365, 50, 15
  CONTROL ADD BUTTON,   hDlg, %IDABORT, "Exit", 565, 365, 50, 15
  ...
  CONTROL ADD TEXTBOX,  hDlg, %IDC_txtIndex, "", 65, 54, 40, 15, %WS_CHILD OR _
    ...
    %WS_EX_RIGHTSCROLLBAR
  CONTROL ADD TOOLBAR,  hDlg, %IDC_TOOLBAR1, "ToolBar1", 0, 0, 0, 0
...
#PBFORMS BEGIN TOOLBARIMAGES %IDR_IMGFILE1->%IDR_IMGFILE2->%IDR_IMGFILE3->->
  ...
  IMAGELIST NEW ICON 32, 32, 32, 3 TO hImgList
