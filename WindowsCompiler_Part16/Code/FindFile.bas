...
#RESOURCE VERSION$ "FileDescription",  "Find Files Utility"
#RESOURCE VERSION$ "FileVersion",      "01.00.0000"
#RESOURCE VERSION$ "InternalName",     "FindFiles"
#RESOURCE VERSION$ "OriginalFilename", "FindFiles.EXE"
#RESOURCE VERSION$ "LegalCopyright",   "Free for Use."
#RESOURCE VERSION$ "ProductName",      "Find Files"
#RESOURCE VERSION$ "ProductVersion",   "01.00.0000"
#RESOURCE VERSION$ "Comments",         "This app allows you to search for files"

#RESOURCE ICON, MyAppIcon, "Search.ico"
...
GLOBAL g_hListView AS DWORD        ' global for listview
'
ENUM lv
  LEFT = 0
  RIGHT
        ...
        CASE %IDC_LISTVIEW
          ...
          SELECT CASE CB.NMCODE
            ...
            ' user double clicks on cell
              ListView_GetItemText g_hListView, @pNMLV.iItem, 1, _
                                   szPath, SIZEOF(szPath)
              ListView_GetItemText g_hListView, @pNMLV.iItem, 0, _
            ...
            ' user clicks on the column header
              ...
              IF SortDirection THEN
                LISTVIEW SORT CB.HNDL, %IDC_LISTVIEW, _
            ...
            '
            CASE %NM_CUSTOMDRAW
            ' custom draw the background colours
              lplvcd = CB.LPARAM
...
#PBFORMS END DIALOG
  ...
  CONTROL HANDLE hDlg, %IDC_LISTVIEW TO g_hListView
  '
