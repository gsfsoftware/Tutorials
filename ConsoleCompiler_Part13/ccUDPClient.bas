...
FUNCTION PBMAIN () AS LONG
  ...
  CON.SCREEN = 30,60
  '
  strResult = QueryUDPServer("COUNT")
  CON.STDOUT strResult
  strResult = QueryUDPServer("SUM 'Eye Colour'='BLUE'")
  CON.STDOUT strResult
  strResult = QueryUDPServer("SUM 'Blood Group'='B RhD negative (B-)'")
  CON.STDOUT strResult
