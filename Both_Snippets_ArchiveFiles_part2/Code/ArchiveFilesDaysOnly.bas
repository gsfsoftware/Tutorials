...
'
#INCLUDE "PB_ArchiveFilesDaysOnly.inc"
...
' the main PB function that is the first to be executed
  ...
  LOCAL strTimePeriod AS STRING  ' time period "DAYS"
  LOCAL strError AS STRING       ' variable to hold any error messages
  LOCAL lngUnits AS LONG         ' number in Days
  '
  strFolder = EXE.PATH$ & "ArchiveFolder"
  strAction = "LOG" ' "DELETE"        ' set to LOG only or DELETE & log
