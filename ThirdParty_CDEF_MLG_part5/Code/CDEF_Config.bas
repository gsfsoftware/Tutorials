...
#LINK "..\MLG\MLG.SLL"
#LINK "zSpinPB10.sll"
#INCLUDE ONCE "..\Libraries\ButtonPlus.bas"
#INCLUDE ONCE"..\Libraries\Tooltips.inc"

' if you intend to use SQL tools use this include
...
%Max_Forms = 10
'
#RESOURCE ICON, AppIcon, "..\Libraries\Graphics\Grid.ico"
#RESOURCE ICON, 2002, "..\Libraries\Graphics\16_CANCEL.ico"
#RESOURCE ICON, 2003, "..\Libraries\Graphics\Help_1.ico"
#RESOURCE ICON, 2004, "..\Libraries\Graphics\save.ico"
#RESOURCE ICON, 2005, "..\Libraries\Graphics\Copy2Clipboard.ico"
#RESOURCE ICON, 2006, "..\Libraries\Graphics\Bigmagnify.ico"
'
#RESOURCE ICON, 2008, "..\Libraries\Graphics\add.ico"
#RESOURCE ICON, 2009, "..\Libraries\Graphics\BackButton.ico"
'
#INCLUDE ONCE "..\Libraries\PB_Common_Windows.inc"
' if you have sql tools use this library
'#include once "..\Libraries\PB_GenericSQL_Functions.inc"
' if you dont have sql tools use this library
...
%AMR_SHORTASSET_UPDATED = 100  ' used to mark an updated row for
                               ' short assets
#INCLUDE ONCE "..\Libraries\PB_MLG_Utilities.inc"
...
#RESOURCE VERSION$ "LegalCopyright",   "Copyright 2021 GSFSoftware"
...
FUNCTION PBMAIN()
  ...
  PBFormsInitComCtls (%ICC_WIN95_CLASSES OR %ICC_DATE_CLASSES OR _
    ...
    CALL SQL_Init
    '
    'strConnectionString =  "DRIVER=SQL Server;UID=strUserID;PWD=" & strPassword & ";" & _
...
#PBFORMS BEGIN DIALOG %IDD_dlgConfgGrids->->
    ...
    DIALOG NEW hParent, "Configure AM System Form Grids", 70, 70, 928, 557, _
    ...
    CONTROL ADD BUTTON,    hDlg, %IDABORT, "Exit", 640, 520, 50, 15
    CONTROL ADD BUTTON,    hDlg, %IDC_COPYTOCLIPBOARD, "Copy to Clipboard", _
        30, 510, 110, 25, %WS_CHILD OR %WS_VISIBLE OR %WS_TABSTOP OR _
...
#PBFORMS END DIALOG
    ...
    IF ISTRUE funPlaceGrid(hDlg,%IDC_MLGGRID1,strSorting,hGrid1,strFormName,strGridName, _
                            10, 125, 900, 380,sheetIDM1, strUserAccess) THEN
    END IF
    '
