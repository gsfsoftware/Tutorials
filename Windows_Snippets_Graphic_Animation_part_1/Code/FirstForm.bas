...
'------------------------------------------------------------------------------
GLOBAL g_astrGraphics() AS STRING
'------------------------------------------------------------------------------
'   ** Declarations **
'------------------------------------------------------------------------------
...
#PBFORMS BEGIN DIALOG %IDD_FIRSTFORM->->
  ...
  DIALOG NEW PIXELS, hParent, "First form ", 332, 159, 581, 487, %WS_POPUP OR _
  ...
  CONTROL ADD TEXTBOX,  hDlg, %IDC_txtPhoneExtension, "", 370, 172, 65, 24, _
  ...
  CONTROL ADD LABEL,    hDlg, %IDC_lblExtension, "Telephone extension", 344, _
    144, 125, 23
