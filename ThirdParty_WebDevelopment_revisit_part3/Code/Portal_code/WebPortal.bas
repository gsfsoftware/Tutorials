...
'
$strPassword = "FF14D8EA42E54868"
#INCLUDE "WebEncrypt.inc"
'
...
' show a graphics window as a splash screen
  ...
  strWebsitePath = "https://odroid007/CGI_BIN/ccCGI_Demo.EXE"
  '
  ...
  '
  strParams = funEncapsulateEncrypt($strPassword,strParams)
  '
