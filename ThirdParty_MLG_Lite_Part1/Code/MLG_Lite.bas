...
$ColumnWidths   = "x20,50,100,100,150,200"
' define the column names
$ColumnNames    = "ID,First name,Surname,Department,Division"
'
...
#PBFORMS BEGIN DIALOG %IDD_dlgMLG_lite->->
  ...
  DIALOG NEW hParent, "MLG Lite", 202, 160, 508, 319, %WS_POPUP OR %WS_BORDER _
