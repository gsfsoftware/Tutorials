...
END FUNCTION
'
FUNCTION funReturnGreeting ALIAS "funReturnGreeting" () EXPORT AS STRING
' return the greeting in this language
' for "Good morning"
  FUNCTION = "Bonjour"
'
END FUNCTION
'
FUNCTION funSayGoodbye ALIAS "funSayGoodbye" () EXPORT AS STRING
' return goodbye in this language
  FUNCTION = "au revoir"
'
END FUNCTION
