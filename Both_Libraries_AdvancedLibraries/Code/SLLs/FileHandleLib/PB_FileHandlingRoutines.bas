' PB_FileHandlingRoutines.bas as SLL
#COMPILE SLL
#DIM ALL
...
'                      of a string
'
FUNCTION funBinaryFileAsString(strFile AS STRING) EXPORT AS STRING
...
FUNCTION funSaveStringAsFile(strFile AS STRING, _
                             strData AS STRING) EXPORT AS LONG
...
FUNCTION funArrayDump(strFile AS STRING, _
                      BYREF a_strWork() AS STRING) EXPORT AS LONG
...
END FUNCTION
'
FUNCTION funArrayDumpLong(strFile AS STRING, a_work() AS LONG) EXPORT AS LONG
...
FUNCTION funReadTheFileAndOutput(strFilename AS STRING, _
                                 ...
                                 strOutputFile AS STRING) EXPORT AS LONG
...
FUNCTION funReadTheFile(strFilename AS STRING) EXPORT AS LONG
...
END FUNCTION
'
FUNCTION funGetRowCount(strFilename AS STRING) EXPORT AS LONG
...
FUNCTION funStartRangeParse(strString AS STRING, _
                            ...
                            lngEndElement AS LONG) EXPORT AS STRING
...
FUNCTION funParseFind(strHeaders AS STRING ,strDelimeter AS STRING _
                     ,strColumnName AS STRING) EXPORT AS LONG
' funParseFind - Find a string in a delimited string by column name
  LOCAL lngR AS LONG
  '
  TRY
