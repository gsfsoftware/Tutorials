...
#PBFORMS BEGIN DIALOG %IDD_dlgReporter->->
  ...
  CONTROL ADD BUTTON,  hDlg, %IDOK, "Display the HTML page", 515, 45, 110, 15
  DIALOG  SEND         hDlg, %DM_SETDEFID, %IDOK, 0
  CONTROL ADD TEXTBOX, hDlg, %IDC_txtURL, "", 160, 46, 330, 13
  CONTROL ADD BUTTON,  hDlg, %IDC_btnBuildReport, "Build A Report", 20, 46, _
    75, 15
  CONTROL ADD LABEL,   hDlg, %IDC_lblURL, "Enter URL here ", 160, 36, 295, 10
...
#PBFORMS END DIALOG
  ...
  '
  lngXstart = 10 : lngYStart = 65
  lngHeight = lngHeight - lngYstart -75
